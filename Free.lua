...
function EclipseHub:Create(options)
    ...
    options.AccentColor = options.AccentColor or Color3.fromRGB(50, 50, 50)
    options.OutlineColor = options.OutlineColor or Color3.fromRGB(15, 15, 15)
    options.BackgroundColor = options.BackgroundColor or Color3.fromRGB(20, 20, 20)
